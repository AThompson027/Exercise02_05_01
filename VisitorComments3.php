        ...
        if (is_dir($dir)) {
            ...
            if (isset($_POST['save'])) {
                ...
                if (empty($_POST['name'])) {
                    ...
                    // this file will be "writable", file pointer to the start, and open in "binary" mode
                    $fileHandle = fopen($saveFileName, "wb");
                    // if the opening of the file is incomplete then there will be an error message
                    if ($fileHandle === false) {
                    ...
                    //if there is contents in the file (file name + data) then it will be saved in the folder
